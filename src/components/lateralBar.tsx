...
export const LateralBar = () => {
  return (
    <nav className='space-y-10 order-2 col-span-2 xl:col-span-1'>
      <section className='w-full rounded-2xl bg-white flex items-center justify-center space-x-5 lg:space-x-0 px-4 py-8 lg:flex-col lg:space-y-3'>
        <div className='w-20 h-20 md:w-28 md:h-28 flex-shrink-0 bg-stone-400 rounded-full border-4 border-ligth-theme-100'></div>
        <div className='lg:text-center lg:space-y-3'>
          <div>
            <span className='text-xs font-bold uppercase text-ligth-theme-200'>
              Seu anfitrião
            </span>
      ...
      <section className='w-full rounded-2xl bg-white mx-auto text-left px-4 py-8 space-y-5'>
        ...
        <form className='space-y-3 flex flex-col'>
          <input
            type='text'
            placeholder='Email'
            className='h-10 border-2 border-ligth-theme-200 rounded-3xl px-5 outline-none'
          />
          <button className='rounded-3xl h-10 bg-ligth-theme-100 font-bold hover:text-white hover:bg-ligth-theme-200 duration-300'>
            Inscrever
          </button>
        </form>
      </section>

      <section className='hidden lg:block w-full rounded-2xl bg-white px-4 py-8 space-y-5'>
          ...
          <div className='grid grid-cols-3 gap-x-4 '>
            ...
            <div className='col-span-2 flex flex-col space-y-1'>
              ...
              <Link href='#' className='group flex gap-4 items-center'>
                <FaArrowRight className='text-ligth-theme-400 group-hover:text-ligth-theme-500' />
                <span className='text-sm font-bold uppercase text-ligth-theme-400 group-hover:text-ligth-theme-500'>
                  Leia Mais
                </span>
              </Link>
            </div>
      ...
      <section className='hidden lg:block w-full rounded-2xl bg-white px-4 py-8 space-y-5'>
        ...
        <div className='space-y-5'>
          ...
          <div className='flex justify-between items-center'>
            <Link
              href='#'
              className='font-bold capitalize hover:text-ligth-theme-400'
            >
              CLOUD
            </Link>
            <span className='text-xl bg-ligth-theme-100 font-bold rounded-full w-10 h-10 p-5 flex justify-center items-center'>
              2
            </span>
          </div>
          <div className='flex justify-between items-center'>
